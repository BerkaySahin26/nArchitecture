...
namespace Persistence.Contexts
{
    public class BaseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                a.ToTable("Brands").HasKey(k => k.Id); //Primary key için
                a.Property(p => p.Id).HasColumnName("Id");    // kolonlar 
                a.Property(p => p.Name).HasColumnName("Name");
                a.HasMany(p => p.Models); //çok var
            });
            ...
            Model[] modelEntitySeeds = { new(1, 1, "Series 4", 1500," "), new(2, 1, "Series 3", 1200," "), new(3, 2, "A180", 1200," ") };
